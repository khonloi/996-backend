...
export declare class CategoriesController {
    ...
    create(createCategoryDto: CreateCategoryDto | CreateCategoryDto[]): Promise<import("./entities/category.entity").Category[]> | Promise<import("./entities/category.entity").Category>;
